...
INSERT INTO `bank_user` (`name`,`email`,`mobile_number`, `pwd`, `role`,`create_dt`)
 VALUES ('jak','jak@mail.com','17273645', '$2y$10$tixC17xU1zGxlI5xnOPMaeUeteXuG9VKv4SgPdphwyE2wF9DDPWEm', 'admin',CURDATE());
...
CREATE TABLE `accounts` (
   ...
   CONSTRAINT `customer_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `bank_user` (`customer_id`) ON DELETE CASCADE
);
...
CREATE TABLE `account_transactions` (
  ...
  CONSTRAINT `acct_user_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `bank_user` (`customer_id`) ON DELETE CASCADE
);
...
CREATE TABLE `loans` (
  ...
  CONSTRAINT `loan_customer_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `bank_user` (`customer_id`) ON DELETE CASCADE
);
...
CREATE TABLE `cards` (
  ...
  `create_dt` date DEFAULT NULL,
  PRIMARY KEY (`card_id`),
  CONSTRAINT `card_customer_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `bank_user` (`customer_id`) ON DELETE CASCADE
);
...
CREATE TABLE `authorities` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `authorities_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `bank_user` (`customer_id`)
);
